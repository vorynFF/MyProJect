...
if __name__ == "__main__":
    zz = zset_getall("api:user:58804776:friendNewIMMsgUserList")
    # zl = json.loads(zz)
    print(zz)
    # redis_friend_list = []
    # friendUserMsgListKey = "api:user:{}:friendNewIMMsgUserList".format(58804776)
    # friendUserListKey = "api:user:{}:getFriendUserList:data".format(58804776)
    # friend_userid_list = []
    # friend_eName_list = []
    # redis_str_res = str_get(friendUserListKey)
    ...
    #         friend_eName_list.append(i['eName'])
    #
    # print(friend_userid_list)
    # print(friend_eName_list)

    # zz = zset_getmax("user:videoTag:1:getTagSubListRanking")
    # print(zz)
    # print(type(zz[0][0]))
